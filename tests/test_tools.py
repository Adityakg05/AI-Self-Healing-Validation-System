"""Tests for AST-based run_tests validator logic.

Tests logic directly without @tool wrapper for isolated testing.
"""
import ast
...
def _validate(code: str, original_code: str = "") -> dict:
    """Mirror of run_tests() logic from tools.py."""
...
def test_broken_original_skips_function_check():
    """If original has syntax errors, skip function check."""
